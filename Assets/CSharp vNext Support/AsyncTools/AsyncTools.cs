...
{
    private static readonly Lazy<Awaiter> updateAwaiter = new Lazy<Awaiter>(()=> new SynchronizationContextAwaiter(UnityScheduler.UpdateScheduler.Context));
	private static readonly Lazy<Awaiter> fixedAwaiter = new Lazy<Awaiter>(() => new SynchronizationContextAwaiter(UnityScheduler.FixedUpdateScheduler.Context));
	private static readonly Lazy<Awaiter> lateUpdateAwaiter = new Lazy<Awaiter>(() => new SynchronizationContextAwaiter(UnityScheduler.LateUpdateScheduler.Context));
	private static readonly Lazy<Awaiter> editorUpdateAwaiter = new Lazy<Awaiter>(() => new SynchronizationContextAwaiter(UnityScheduler.EditorUpdateScheduler.Context));
	...
	public static Awaiter ToMainThread() => updateAwaiter.Value;

	/// <summary>
	/// Switches execution to the EditorUpdate context of the main thread.
	/// </summary>
	public static Awaiter ToEditorUpdate() => editorUpdateAwaiter.Value;

	/// <summary>
	/// Switches execution to the Update context of the main thread.
	/// </summary>
	public static Awaiter ToUpdate() => updateAwaiter.Value;

	/// <summary>
	/// Switches execution to the LateUpdate context of the main thread.
	/// </summary>
	public static Awaiter ToLateUpdate() => lateUpdateAwaiter.Value;

	/// <summary>
	/// Switches execution to the FixedUpdate context of the main thread.
	/// </summary>
	public static Awaiter ToFixedUpdate() => fixedAwaiter.Value;
